...
Route::get('/agent-dashboard',[dashboardController::class ,'agentdashboard'] )->name('agentdashboard-login');
...
Route::middleware(['auth','partenaire'])->group(function(){
    Route::get('/partenaire-dashboard',[dashboardController::class ,'partenairedashboard'] )->name('partenairedashboard-login');
...
Route::middleware(['auth','superviseur'])->group(function(){
    Route::get('/superviseur-dashboard',[dashboardController::class ,'superviseurdashboard'] )->name('superviseurdashboard-login');
