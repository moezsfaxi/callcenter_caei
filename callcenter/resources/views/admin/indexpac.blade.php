            ...
            <div id="kt_app_content_container" class="app-container container-fluid">
                ...
                <div class="card card-flush">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table style="background-color: white !important; " class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                        <thead>
    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="fw-bolder">Rendez-vous Pompe a chaleur</h2>
...
<!-- <script src="{{ asset('assets/js/live-search') }}"></script> -->
...
<!-- <script>
    ...
    // Function to filter table rows based on name and date
    function filterTable() {
        const nameQuery = searchInput.value.toLowerCase();
        const dateQuery = dateInput.value;
        ...
        tableRows.forEach(row => {
            const prospectName = row.querySelector('td:first-child').textContent.toLowerCase();
            const rdvDate = row.querySelector('td:nth-child(6)').textContent; // Assumes "Date du RDV" is the 6th column

            // Check if row matches the filters
            const nameMatch = prospectName.includes(nameQuery);
            const dateMatch = dateQuery === "" || rdvDate === dateQuery;
