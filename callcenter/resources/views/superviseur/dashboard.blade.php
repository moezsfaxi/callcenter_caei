...
<div class="container mt-1">
    <h1 class="text-center">Statistiques de Superviseur</h1>
    ...
    <h4 class="text-center">Statistiques de qualification</h4>
        <div class="row text-center mb-4 qualification-section">
            
            <!-- NRP -->
            <div class="col-md-4 ">
                <div class="qual-box nrp-box shadow">
                    <h4>RDVs Affectées</h4>
                    <p class="qual-number"> </p>
                </div>
            </div>
            <div class="col-md-4 ">
                <div class="qual-box hc-box shadow">
                    <h4>RDVs Non  Affectée</h4>
                    <p class="qual-number"> </p>
                </div>
            </div>
            <!-- HC -->
            ...
            <div class="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center">
                    <div class=" rounded-lg bg-gray-100 dark:bg-gray-700 flex   justify-center me-3">
                        <h5 class="text-2xl font-bold text-gray-900 dark:text-white pb-1">Statistiques</h5>
                    </div>
                    <div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            const options = {
                ...
                series: [{
                        ...
                        color: "#FCFE19",
                        data:   [ 
                        { x: "Date", y: {{ $statistics['rdvPompe']['total'] }} }
                    ],
                    },
                    {
                        name: "Thermostat",
                        color: "#24D26D",
                        data: [
                        { x: "Date", y: {{ $statistics['rdvThermostat']['total'] }} }
                    ],
                    },
                    {
                        name: "Panneaux",
                        color: "#87CEEB",
                        data:[
                        { x: "Date", y: {{ $statistics['rdvPanneaux']['total'] }} }
                    ],
                    },
                    {
                        name: "Audit",
                        color: "#fe2419",
                        data: [
                        { x: "Date", y: {{ $statistics['rdvAudit']['total'] }} }
                    ],
                    },
                ],
                plotOptions: {
            ...
            // Vérifiez si l'élément avec l'ID "column-chart" existe
    ...
    <style>
        ...
        .qualification-section {
            ...
            .nrp-box {
                border-left: 10px solid #FE81CC;
                border-right: 10px solid #FE81CC;
            }
