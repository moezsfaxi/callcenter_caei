										...
										<div class="menu-content d-flex flex-column px-3">
											...
											<div class="d-flex flex-column text-center">
												<div class="fw-bold d-flex align-items-center justify-content-center fs-5">
													{{ Auth::user()->name }}
													<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Superviseur</span>
												</div>
												<span  class="fw-semibold text-muted text-hover-primary fs-7 mb-2" style="word-break: break-all;">{{ Auth::user()->email }}</span>
											</div>
											<!--end::Username-->
										</div>
									</div>
						...
						<div class="d-flex flex-column justify-content-between h-100 hover-scroll-overlay-y my-2 d-flex flex-column" id="kt_app_sidebar_main" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_header" data-kt-scroll-wrappers="#kt_app_main" data-kt-scroll-offset="5px">
							...
							<div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false" class="flex-column-fluid menu menu-sub-indention menu-column menu-rounded menu-active-bg mb-7">
								...
								<div  class="menu-item here show menu-accordion">
									<!--begin:Menu link-->
									<a class="menu-link" href="{{ route('superviseur-dashboard-login') }}">
								...
								<div  class="menu-item here show menu-accordion">
									<!--begin:Menu link-->
									<a class="menu-link" href="{{ route('superviseur-post') }}">
										<span class="menu-icon">
											<i class="ki-duotone ki-element-11 fs-1">
												<span class="path1"></span>
												<span class="path2"></span>
								...
								<div class="menu-item">
									<!--begin:Menu link-->
									<a class="menu-link" href="{{ route('superviseur-rdv-thermostat.index') }}">
										<span class="menu-icon">
								...
								<div class="menu-item">
									<!--begin:Menu link-->
									<a class="menu-link" href="{{ route('superviseur-rdv-pompe-a-chaleur.index') }}">
										<span class="menu-icon">
                                            <i class="fas fa-fire fs-1"></i>
                                                <span class="path1"></span>
												<span class="path2"></span>
											</i>
										</span>
								...
								<div class="menu-item">
									<!--begin:Menu link-->
									<a class="menu-link" href="{{ route('superviseur-rdv-panneaux-photovoltaique.index') }}">
										<span class="menu-icon">
